...
Ve statistikách navíc před názvem každé oblasti i podoblasti uvidíš malý barevný **trojúhelník ▶**. Je to hrubý odhad — pomocí zjednodušeného modelu křivky zapomínání, v duchu podobných principů jako u nástrojů pro rozestupové opakování typu Anki — jak moc už jsi danou látku pravděpodobně zapomněl, aby ti napověděl, co má smysl zopakovat jako první. Bere v potaz, jak dávno jsi kterou kartičku naposled zopakoval, v jak vysokém Leitnerově košíku se nachází (u vyšších košíků se předpokládá, že vydrží v paměti déle), a jak často se ta kartička v minulosti vracela zpátky do košíku č. 1 (kartička, která se vrací opakovaně, "vyprchá" rychleji než ta, co stoupala plynule). Zelená znamená, že látka je pravděpodobně ještě čerstvá; červená, že je asi čas si ji projít znovu. Na rozdíl od tečky pro zkušební minimum se trojúhelník zobrazuje na úrovni oblastí i podoblastí a nepotřebuje k tomu žádné nastavení v souboru sady — jde čistě o načasování, ne o připravenost na zkoušku, a nic se u toho v appce nedá ručně doladit. Kartičky, které jsi nezopakoval od doby, kdy tahle funkce přibyla, se zpočátku ukážou jako úplně "zapomenuté" (červené), dokud je znovu neprojdeš a appka tak nezíská časový údaj, ze kterého může vycházet.
