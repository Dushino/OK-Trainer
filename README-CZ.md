...
V seznamu oblastí a podoblastí je před názvem trojmístný indikátor složený ze znaků ◼ a ◻. Je to hrubý odhad pomocí zjednodušeného modelu křivky zapomínání v duchu podobných principů jako u nástrojů pro opakování typu Anki, jak moc už jsi danou látku pravděpodobně zapomněl, aby ti napověděl, co má smysl zopakovat jako první. Bere v potaz, jak dávno jsi kterou kartičku naposled zopakoval, v jak vysokém Leitnerově košíku se nachází (u vyšších košíků se předpokládá, že vydrží v paměti déle), a jak často se ta kartička v minulosti vracela zpátky do košíku č. 1. Zelená ◼◻◻ znamená, že látka je pravděpodobně ještě čerstvá; červené ◼◼◼, že je čas si ji projít znovu.
